...
<body background="showresult.jpg">
	...
	<div class="container">
    	<div class="row">
    		<p></p>
    		<h1 align="center"><strong><s:property value="AuthorName"/>&emsp;作品</strong></h1>   
	            ...
	            <div class="panel panel-default panel-table">
	              	<div class="panel-body">
	                    ...
	                    <tr>
	                  	...
	                  	<tbody>
	                    <s:iterator value="books" var="single_book">
						<tr>
							<td align="center">
								<s:url var="eurl" value="Origin">
									<s:param name="AuthorName" value="AuthorName"></s:param>
									<s:param name="Publisher" value="#single_book.Publisher"></s:param>
									<s:param name="PublishDate" value="#single_book.PublishDate"></s:param>
									<s:param name="Price" value="#single_book.Price"></s:param>
									<s:param name="Title" value="#single_book.Title"></s:param>
								</s:url>
								<s:url var="durl" value="Delete">
									<s:param name="SelectedISBN" value="%{#single_book.ISBN}"></s:param>
									<s:param name="AuthorName" value="%{AuthorName}"></s:param>
								</s:url>
	                        	<s:a class="btn btn-default" href="%{eurl}"><em class="fa fa-pencil"></em></s:a>
	                           	<s:a class="btn btn-danger" href="%{durl}"><em class="fa fa-trash"></em></s:a>
	                        </td>
							...
							<td>
								<s:property value="%{#single_book.PublishDate}"/>
							</td>
							<td>
